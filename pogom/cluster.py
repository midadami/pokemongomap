...
import clsmath
from .utils import get_pokemon_name, get_pokemon_rarity, get_pokemon_types, get_args, now
...
def main(raw):
    args = get_args();
    radius = 70
    time_threshold = args.spawn_clustering  # 4 minutes is alright to grab a pokemon since most times are 30m+
